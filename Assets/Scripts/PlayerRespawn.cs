...
public class PlayerRespawn : MonoBehaviour
{
    ...
    public void ReachedCheckPoint(float x, float y) //Metodo para detectar si se pasa por el checkpoint
    {
        ...
        PlayerPrefs.SetFloat("checkPointPositionX", 1.049946f);//Guarda la informacion de la x
        PlayerPrefs.SetFloat("checkPointPositionY", 0.4986398f);//Guarda la informacion de la y
    }
